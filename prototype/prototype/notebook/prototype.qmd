...
We will be referring to the [Climate and Society](https://www.amazon.com/Climate-Society-Transforming-Future-Leichenko/dp/0745684394) book by Robin Lecheinko and Karen O’Brien.
...
::: {.callout-note}
You may have noticed that our agent definition uses a `traceable` decorator. This is a feature of the Langchain framework that allows us to trace the execution of the agent and store the logs for auditing purposes.
